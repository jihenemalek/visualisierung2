...
bool InputClass::IsKeyPressed(int code)
{
...
void InputClass::GetMouseLocation(int& mouseX, int& mouseY, bool& leftclick)
{
...
void InputClass::GetRelativeMouseLocation(int& mouseX, int& mouseY, bool& leftclick)
{
	leftclick = m_mouseState.rgbButtons[0] & 0x80;
